...
// re-create the whole question data to avoid unintentonal reference change
...
function setOpttions(options) {
    model.value.data.options = options;
}

function addOption() {
    setOpttions([...getOptions(), { uuid: uuidv4(), text: "" }]);
    dataChange();
}
